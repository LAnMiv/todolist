...
export const createTaskElement = (task) => {
	return `
		<li class="tasks__item item" data-id-task="${task.id}">
			<label class="item__checkbox-complete" title="Complete/active">
				<input class="item__checkbox-input-complete visually-hidden" type="checkbox" ${task.completed ? "checked" : ""}>
			...
			<p style="${replaceTaskTextStyle(task.completed)}">${task.text}</p>
